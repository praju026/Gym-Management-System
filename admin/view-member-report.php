...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">FIZQ FITNESS CENTER Admin</a></h1>
</div>
<!--close-Header-part--> 
            ...
            <div class="row-fluid">
              <div class="span4">
                <table class="">
                  <tbody>
                    <tr>
                      <td><h4>FIZQ FITNESS CENTER</h4></td>
                    </tr>
                    <tr>
                      <td>Deralakatte, Mangaluru</td>
                    </tr>
                    
                    <tr>
                      <td>Tel: 7338490213</td>
                    </tr>
                    <tr>
                      <td >Email: support@fizq.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      <td><div class="text-center">FFC-SS-<?php echo $row['user_id']; ?></div></td>
